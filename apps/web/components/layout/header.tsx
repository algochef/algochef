...
const Header = () => {
  return (
    <div className="w-11/12 fixed top-0 left-0 right-0 z-50 mx-auto bg-gray-300/15 dark:bg-gray-50/5 backdrop-blur-xs h-16 flex justify-between items-center py-4 px-16 rounded-xl">
