...
import { Code, FileSpreadsheet, Trophy, Zap } from "lucide-react";
  ...
  return (
    <div className="w-full mx-auto bg-gray-100/30 dark:bg-neutral-800/30 backdrop-blur-xs h-12 flex justify-between items-center py-4 px-16 border-b-[1px] z-1000">
      <nav className="flex items-center space-x-8">
        ...
        <Link
          href={"/practice"}
          className="flex items-center space-x-1 text-sm text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-100"
        >
          <Code size={16} />
          <span>Practice</span>
        </Link>
