...
export function AddProblemModal() {
  ...
  const onTagChange = (payload: {
    ...
    setProblemData((prevState) => {
      let newTags =
        payload.tagType === "topic" ? prevState.tags : prevState.companyTags;
      if (payload.type === "add") {
    ...
    <Dialog open={modalOpen} onOpenChange={setModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Paste the problem URL and we will try to parse the problem details
            automatically.
          </DialogDescription>
        </DialogHeader>
        <form
          ref={formRef}
          onSubmit={parseProblemData}
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="grid gap-3">
                      <Label htmlFor="difficultyNumeric">
                        Difficulty (Numeric)
                      </Label>
                      <Input
                        id="difficultyNumeric"
                        name="difficultyNumeric"
                        defaultValue={problemData.difficultyNumeric}
                        type="number"
                    ...
                    <div className="grid gap-3">
                      ...
                      <Select
                        defaultValue={problemData.difficultyCategory}
                        onValueChange={(diff: string) => {
                          setProblemData((prev) => {
                            return {
                              ...prev,
