        ...
        {problems &&
          problems.map((problem) => {
            return (
              <div
                key={problem.id}
                className="flex justify-between px-8 odd:bg-gray-100/40 py-2 items-center rounded-md bg-white dark:bg-neutral-900/30 dark:odd:bg-neutral-800/50"
              >
                        ...
                        {problem.companyTags &&
                          problem.companyTags.map((tag) => {
                            return (
                              <h2
                                key={tag.slug}
                                className="text-sm tracking-tighter  bg-gradient-to-t from-gray-300/50 to-gray-100/50 rounded-md px-2 py-0.5 text-gray-600 w-fit shadow border-[1px] h-fit dark:from-gray-700/50 dark:border-gray-200/10 dark:to-gray-900 dark:text-gray-50"
                              >
