...
const ProgressBar = ({
  ...
  const overallPercentageFraction = Math.ceil(
    (overallPercentage - overallPercentageDecimal) * 100,
  );
    ...
    <div className=" p-4 rounded-lg  lg:max-w-[350px]">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative w-40 h-40">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="text-lg md:text-xl lg:text-2xl font-semibold text-gray-800 dark:text-gray-50">
              ...
              <span className="text-xs md:text-sm font-normal text-gray-500 dark:text-gray-300">
                .{overallPercentageFraction}%
              </span>
            </div>
            <div className="text-xs md:text-sm text-gray-600 mt-1 dark:text-gray-400">
              Solved
            </div>
          </div>
        </div>
        ...
        <div className="pr-8 space-y-3 flex flex-col items-center justify-center">
          ...
          <div className="flex items-center">
            <div className="text-center">
              <div className="text-xs md:text-sm font-medium text-amber-500">
                Med.
              </div>
              <div className="text-sm md:text-md font-semibold text-gray-800 dark:text-gray-100">
