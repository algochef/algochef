    ...
    <div className="shadow h-fit rounded-b-md">
      ...
      <div className="flex flex-col items-center mt-12">
        <div className="flex flex-col items-center">
          ...
          <h6 className="tracking-tighter font-medium text-gray-600">
            @{userInfo.username}
          </h6>
          ...
          <>
            <div className="flex space-x-2 mt-4">
              {userInfo.social.githubUrl && (
                <>
                  <Link
                    href={userInfo.social.githubUrl}
              ...
              {userInfo.social.linkedinUrl && (
                <>
                  <Link
                    href={"https://www.linkedin.com/in/joybiswas389"}
                    className="cursor-pointer"
                  >
              ...
              {userInfo.social.twitterUrl && (
                <>
                  <Link
                    href={userInfo.social.twitterUrl}
                    className="cursor-pointer"
                  >
                    <IconBrandX size={22} />
                  </Link>
              ...
              {userInfo.social.instagramUrl && (
                <>
                  <Link
                    href={userInfo.social.instagramUrl}
                    className="cursor-pointer"
                  >
        ...
        <div className="flex flex-col my-4 w-full items-center">
          ...
          <div className="grid grid-cols-3 px-4 w-full">
            <div className="flex flex-col items-center">
              <h3 className="text-2xl font-bold font-(family-name:--font-inter)">
                375
              </h3>
