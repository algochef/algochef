    ...
    <div>
      <div className="flex flex-col items-center">
        <div className="flex flex-col w-11/12 my-2">
          ...
          <h6 className="text-base text-gray-500 tracking-tight">
            Never miss a coding contest with our comprehensive tracker
          </h6>
        ...
        <Tabs defaultValue="upcoming" className="w-11/12 mb-16">
          <TabsList className="bg-gray-100 dark:bg-gray-100/5">
            <TabsTrigger value="upcoming" className="border-0">
              Upcoming
            </TabsTrigger>
            <TabsTrigger value="past" className="border-0">
              Past Contests
            </TabsTrigger>
          </TabsList>
          <LoadContests />
