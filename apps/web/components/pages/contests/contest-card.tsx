    ...
    <div className="border-[1px] p-6 flex flex-col space-y-3 rounded-md">
      ...
      <div className="flex space-x-2 items-center">
        ...
        <p className="text-sm tracking-tight">
          {formattedTime.toLocaleLowerCase()} •{" "}
          {formatDuration(contest.endsAt - contest.startsAt)}
        </p>
      </div>
      <p className="tracking-tight border-[1px] border-gray-500/30 dark:border-gray-200/20 w-fit px-3 rounded-xl font-medium text-xs py-0.5">
        {startText}
      </p>
