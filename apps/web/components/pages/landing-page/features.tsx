  ...
  return (
    <div className="flex flex-col items-center justify-center py-4">
      ...
      <div className="grid grid-cols-3 gap-2 items-center justify-center pt-2 pb-4">
        {COMPANIES.map((company) => {
          return (
            <div
              key={company.id}
              className="border-[1px] border-gray-400/30 rounded-xl"
            >
      ...
      <div className="w-7/12 flex flex-col items-center justify-center text-center flex-wrap text-wrap">
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-8 md:leading-10 lg:leading-12 tracking-tighter">
          Everything You Need to Excel
        </h2>
        <p className="text-gray-500">
          From curated problem sets to real-time contest tracking, we&apos;ve
          got all the ingredients for your coding success.
        </p>
      </div>
